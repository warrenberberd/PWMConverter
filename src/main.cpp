...
void loop() {
  ...
  if(DURATION_1>REAL_PWM_MAX_VALUE1) REAL_PWM_MAX_VALUE1=DURATION_1;
  if(DURATION_2>REAL_PWM_MAX_VALUE2) REAL_PWM_MAX_VALUE1=DURATION_2;
  if(DURATION_3>REAL_PWM_MAX_VALUE3) REAL_PWM_MAX_VALUE1=DURATION_3;
  if(DURATION_4>REAL_PWM_MAX_VALUE4) REAL_PWM_MAX_VALUE1=DURATION_4;
